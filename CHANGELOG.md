...
### Fixed
- **Rich-text / Markdown editors** (Notes, Convictions, Biography, Tenets,
  item descriptions) are now clearly legible: bright full-contrast text, a
  slightly larger size (1rem / 1.7 line-height), and a solid dark backing —
  previously the text was muted and low-contrast.
